 ...
 * @Author: your name
 * @Date: 2019-07-16 16:20:15
 * @LastEditTime: 2019-08-13 16:21:29
...
<script>
import { create, uploadPath } from '@/api/excavator'
    ...
    handlePublish: function(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          // console.log(finalGoods.pic_url)
          // debugger
          ...
          create(finalGoods).then(response => {
            this.$notify.success({
              title: '成功',
              message: '创建成功'
            })
