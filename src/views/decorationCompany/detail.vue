  ...
  <div v-loading="loadingDetail" class="app-container">
    ...
    <el-card class="box-card">
      ...
      >
        <div style="width:100px ;height:100px ">
          <img :src="departData.avatar" style="width:100px ;height:100px " >
        </div>
        <el-upload
          ref="upLoadAvatar"
          :headers="headers"
    ...
    <el-card>
      ...
      <el-table :data="depart" style="width: 100%">
        ...
        <el-table-column prop="work_year" label="工作年限"/>
        <el-table-column prop="example_number" label="案例数"/>
        <el-table-column prop="service_number" label="订单数"/>
