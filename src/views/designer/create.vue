<template>
  <div class="app-container">
    <el-card class="box-card">
      <h3>新增设计师</h3>
      <el-form ref="newDesigner" :rules="rules" :model="newDesigner" label-width="150px">
        <el-form-item label="姓名" prop="nickname">
          <el-input v-model="newDesigner.nickname" />
        </el-form-item>
        ...
        <el-form-item label="手机号码" prop="mobile">
          <el-input v-model="newDesigner.mobile" />
        </el-form-item>
        <el-form-item label="工作年限" prop="workYear">
          <el-input v-model="newDesigner.workYear" />
        </el-form-item>
        <el-form-item label="出生日期">
          <el-col :span="11">
            <el-date-picker
              v-model="newDesigner.birthday"
              type="date"
              placeholder="选择日期"
              style="width: 100%;"
        ...
        <!-- <el-form-item label="归属机构" prop="departCode">
          <el-input v-model="newDesigner.departCode" />
        </el-form-item>-->
        <el-form-item label="归属机构">
          <el-select v-model="newDesigner.departCode" clearable placeholder="请选择所属机构">
            <el-option
        ...
        <!-- <el-form-item v-if="example_source==0" class="casePic" label="案例图片">
          ...
          <div class="picList" style="margin-top:30px">
            <div class="cPic" v-for="(item,index) in newDesigner.url_list" :key="index">
...
export default {
  ...
  methods: {
    ...
    //   this.newDesigner.url_list.push({
    ...
    handleRemove(file, fileList) {
      for (var i = 0; i < this.newDesigner.gallery.length; i++) {
        // 这里存在两种情况
