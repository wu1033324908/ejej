 ...
 * @Author: your name
 * @Date: 2019-08-02 10:42:01
 * @LastEditTime: 2019-08-16 14:43:27
...
<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.keyword" clearable class="filter-item" style="width: 200px;" placeholder="请输入标题"/>
      ...
      <el-button class="filter-item" type="primary" icon="el-icon-edit" @click="handleCreate">新增招聘</el-button>
    </div>
...
<script>
import { labourWorkList, labourWorkDel } from '@/api/employment'
...
export default {
  ...
  methods: {
    ...
    handleCreate() {
      this.$router.push({ path: '/informationPublish/employmentCreate' })
    },
    handleUpdate(row) {
      this.$router.push({ path: '/informationPublish/employmentEdit', query: { labour_code: row.labour_code }})
    },
    showDetail(detail) {
