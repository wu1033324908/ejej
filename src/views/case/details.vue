<template>
  <div class="app-container">
    <el-card class="box-card">
      <h3>查看{{ example_type==0 ? "设计师":example_type==1 ? "零工" : "项目经理" }}案例</h3>
      <el-form
        ref="detailCase"
        :disabled="true"
        :rules="rules"
...
export default {
  ...
  methods: {
    ...
    handlePublish() {
      ...
      this.detailCase.exampleSource = this.example_source.toString()
