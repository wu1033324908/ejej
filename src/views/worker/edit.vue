      ...
      <el-form ref="editWorker" :rules="rules" :model="editWorker" label-width="150px">
        ...
        <el-form-item label="工种" prop="typeWork">
          <el-select
            ...
            placeholder="请选择工种"
          >
            <el-option label="水电工" :value="0" />
            <el-option :value="1" label="水泥工"></el-option>
            <el-option :value="2" label="木匠"></el-option>
            <el-option :value="3" label="电工"></el-option>
            <el-option :value="4" label="打孔"></el-option>
          </el-select>
        </el-form-item>
