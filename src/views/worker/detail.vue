    ...
    <el-card class="box-card">
      ...
      <div style="display:inline-block ; vertical-align: top; margin-right:100px; width:100px;  height : 100px">
        <div style=" width:100px;  height : 100px" >
          <img :src="workerData.avatar" style="width:100px ;height:100px " >
        </div>
...
export default {
  ...
  methods: {
    ...
    addRelevanceLabel(row) {
      const labelData = {
        serviceCode: this.workerData.serviceCode,
    ...
    addLableDetail() {
      ...
      InfoData.service_code = this.workerData.serviceCode
      // service_type: 0
    ...
    addLabel() {
      ...
      newLableData.serviceCode = this.workerData.serviceCode
      // {
      //   serviceLabelCode: row.serviceLabelCode,
