...
<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select clearable v-model="classL" placeholder="请选择" @change="getL2">
        <el-option v-for="item in options" :key="item.value" :label="item.name" :value="item.id"></el-option>
      </el-select>
      <el-select clearable v-model="classL2" placeholder="请选择">
        <el-option v-for="item in optionsL2" :key="item.value" :label="item.name" :value="item.id"></el-option>
      </el-select>
      <el-button
        type="primary"
    ...
    <!-- 编辑的弹窗 -->
    <el-dialog title="编辑二级分类" :visible.sync="dialogEdit" width="800">
    ...
    <!-- 新增的弹窗 -->
    <el-dialog title="新增三级分类" :visible.sync="dialogCreate" width="800">
      <el-form :model="formCreate" ref="ruleForm" :rules="rules">
        <el-form-item label="一级分类" :label-width="'180px'">
          <el-select v-model="class1" @change="getL12" placeholder="请选择一级分类">
            <el-option
        ...
        <el-form-item label="名称" :label-width="'180px'" prop="name" style="width:600px">
          <el-input v-model="formCreate.name" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="备注" :label-width="'180px'" prop="desc" style="width:600px">
