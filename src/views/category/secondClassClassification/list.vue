...
<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="classL" clearable placeholder="请选择">
    ...
    >
      ...
      <el-table-column align="center" min-width="100" label="下属三级分类" prop="wc1">
        <!-- <template
          slot-scope="scope"
        >{{scope.row.status==0 ? '未知' : scope.row.status==1 ? '男' : "女" }}</template>-->
      </el-table-column>
    ...
    <!-- 新增的弹窗 -->
    <el-dialog :visible.sync="dialogCreate" title="新增二级分类" width="800">
      <el-form :model="formCreate">
        <el-form-item :label-width="'180px'" label="一级分类">
          <el-select v-model="class1" clearable placeholder="请选择">
            <el-option
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="createL1">确 定</el-button>
      </div>
    </el-dialog>
    <!-- 新增三级分类的弹窗 -->
    <el-dialog :visible.sync="dialogL2" title="新增三级分类" width="800">
      ...
      <el-table :data="listL2">
        ...
        >
          <template slot-scope="scope">
            ...
            <!-- <el-button type="primary" @click="handleAddL2(scope.row)"></el-button> -->
            <el-button v-show="scope.row.state==1" type="danger" @click="handleForbid(scope.row)">禁用</el-button>
            <el-button
      ...
      <el-dialog :visible.sync="dialogCreateL2" width="30%" title="新增三级分类" append-to-body>
      ...
      <el-dialog :visible.sync="dialogEditL2" width="30%" title="编辑三级分类" append-to-body>
