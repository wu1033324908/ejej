  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-table :data="products">
        ...
        <el-table-column property="productName" label="货品名称" />
        <el-table-column property="price" label="货品售价" />
        <el-table-column property="costPrice" label="成本价" />
        <el-table-column property="number" label="货品数量" />
        <el-table-column property="weight" label="货品重量" />
        <el-table-column :formatter="supplier" property="brandId" label="供应商"/>
...
export default {
  ...
  //     const _this = this
  //     console.log(_this)
  //     if (!_this.brandList) return
  //     for (const i in _this.brandList) {
  //       if (v === _this.brandList.value) {
  //         return _this.brandList[i].label
  //       }
  //     }
  //   }
  // },
