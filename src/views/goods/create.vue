  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        ...
        <el-form-item label="商品总库存" prop="commodityStocks">
          <el-input v-model="goods.commodityStocks">
    ...
    <el-card class="box-card">
      ...
      <el-table :data="products">
        ...
        <el-table-column property="costPrice" width="100" label="成本价" />
        <el-table-column property="number" width="100" label="货品数量" />
        <el-table-column property="weight" width="100" label="货品重量" />
        <el-table-column property="brandId" width="150" :formatter="supplier" label="供应商"></el-table-column>
...
<script>
import { publishGoods, listCatAndBrand, uploadPath } from "@/api/goods";
...
export default {
  ...
  methods: {
    ...
    handlePublish: function() {
      // this.goods.gallery = JSON.stringify(this.goods.gallery)
